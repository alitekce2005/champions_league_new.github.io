...
// 🔥 V3 DENGELENMİŞ GOL VERİ YAPISI (FİNAL) 🔥
const takimGolVerisi = {
    // --- TIER 1: MAXIMUM GÜÇ (Real Madrid, City vb.) ---
    // Düzeltme: Üst limit 6-7'den 5'e çekildi. Kötü gün (0 gol) ihtimali arttı.
    "REAL MADRID": { MAX: [0, 1, 1, 2, 2, 3, 3, 4, 4, 5], YUKSEK: [0, 1, 1, 2, 2, 3, 3, 4], ORTA: [0, 0, 1, 1, 2, 2, 3, 3], DUSUK: [0, 0, 1, 1, 2, 2, 3], MINIMUM: [0, 0, 0, 1, 1, 2] },
    "MANCHESTER CITY": { MAX: [0, 1, 1, 2, 2, 3, 3, 4, 4, 5], YUKSEK: [0, 1, 1, 2, 2, 3, 3, 4], ORTA: [0, 0, 1, 1, 2, 2, 3, 3], DUSUK: [0, 0, 1, 1, 2, 2, 3], MINIMUM: [0, 0, 0, 1, 1, 2] },
    "BAYERN MUNICH": { MAX: [0, 1, 1, 2, 2, 3, 3, 4, 4, 5], YUKSEK: [0, 1, 1, 2, 2, 3, 3, 4], ORTA: [0, 0, 1, 1, 2, 2, 3, 3], DUSUK: [0, 0, 1, 1, 2, 2, 3], MINIMUM: [0, 0, 0, 1, 1, 2] },
    "LIVERPOOL": { MAX: [0, 1, 1, 2, 2, 3, 3, 4, 4, 5], YUKSEK: [0, 1, 1, 2, 2, 3, 3, 4], ORTA: [0, 0, 1, 1, 2, 2, 3, 3], DUSUK: [0, 0, 1, 1, 2, 2, 3], MINIMUM: [0, 0, 0, 1, 1, 2] },
    "BARCELONA": { MAX: [0, 1, 1, 2, 2, 3, 3, 4, 4, 5], YUKSEK: [0, 1, 1, 2, 2, 3, 3, 4], ORTA: [0, 0, 1, 1, 2, 2, 3, 3], DUSUK: [0, 0, 1, 1, 2, 2, 3], MINIMUM: [0, 0, 0, 1, 1, 2] },
    "MANCHESTER UNITED": { MAX: [0, 1, 1, 2, 2, 3, 3, 4, 4, 5], YUKSEK: [0, 1, 1, 2, 2, 3, 3, 4], ORTA: [0, 0, 1, 1, 2, 2, 3, 3], DUSUK: [0, 0, 1, 1, 2, 2, 3], MINIMUM: [0, 0, 0, 1, 1, 2] },

    // --- TIER 2: YÜKSEK GÜÇ (PSG, Chelsea vb.) ---
    // Tier 1 ile rekabet edebilmeleri için gol potansiyelleri korundu.
    "PARIS SAINT GERMAIN": { MAX: [0, 1, 1, 2, 2, 3, 3, 4, 5], YUKSEK: [0, 0, 1, 1, 2, 2, 3, 3, 4], ORTA: [0, 0, 1, 1, 2, 2, 3], DUSUK: [0, 0, 0, 1, 1, 2, 2], MINIMUM: [0, 0, 0, 1, 1, 2] },
    "CHELSEA": { MAX: [0, 1, 1, 2, 2, 3, 3, 4, 5], YUKSEK: [0, 0, 1, 1, 2, 2, 3, 3, 4], ORTA: [0, 0, 1, 1, 2, 2, 3], DUSUK: [0, 0, 0, 1, 1, 2, 2], MINIMUM: [0, 0, 0, 1, 1, 2] },
    "JUVENTUS": { MAX: [0, 1, 1, 2, 2, 3, 3, 4, 5], YUKSEK: [0, 0, 1, 1, 2, 2, 3, 3, 4], ORTA: [0, 0, 1, 1, 2, 2, 3], DUSUK: [0, 0, 0, 1, 1, 2, 2], MINIMUM: [0, 0, 0, 1, 1, 2] },
    "ARSENAL": { MAX: [0, 1, 1, 2, 2, 3, 3, 4, 5], YUKSEK: [0, 0, 1, 1, 2, 2, 3, 3, 4], ORTA: [0, 0, 1, 1, 2, 2, 3], DUSUK: [0, 0, 0, 1, 1, 2, 2], MINIMUM: [0, 0, 0, 1, 1, 2] },
    "AC MILAN": { MAX: [0, 1, 1, 2, 2, 3, 3, 4, 5], YUKSEK: [0, 0, 1, 1, 2, 2, 3, 3, 4], ORTA: [0, 0, 1, 1, 2, 2, 3], DUSUK: [0, 0, 0, 1, 1, 2, 2], MINIMUM: [0, 0, 0, 1, 1, 2] },
    "TOTTENHAM HOTSPUR FC": { MAX: [0, 1, 1, 2, 2, 3, 3, 4, 5], YUKSEK: [0, 0, 1, 1, 2, 2, 3, 3, 4], ORTA: [0, 0, 1, 1, 2, 2, 3], DUSUK: [0, 0, 0, 1, 1, 2, 2], MINIMUM: [0, 0, 0, 1, 1, 2] },

    // --- TIER 3: ORTA GÜÇ (Atletico, Dortmund vb.) ---
    // Alt limitler iyileştirildi, daha dirençliler.
    "ATLETICO MADRID": { MAX: [0, 1, 1, 2, 2, 3, 4], YUKSEK: [0, 0, 1, 1, 2, 2, 3], ORTA: [0, 0, 1, 1, 2, 2, 3], DUSUK: [0, 0, 0, 1, 1, 2, 2], MINIMUM: [0, 0, 0, 1, 1, 2] },
    "BORUSSIA DORTMUND": { MAX: [0, 1, 1, 2, 2, 3, 4], YUKSEK: [0, 0, 1, 1, 2, 2, 3], ORTA: [0, 0, 1, 1, 2, 2, 3], DUSUK: [0, 0, 0, 1, 1, 2, 2], MINIMUM: [0, 0, 0, 1, 1, 2] },
    "FC INTERNAZIONALE MILANO": { MAX: [0, 1, 1, 2, 2, 3, 4], YUKSEK: [0, 0, 1, 1, 2, 2, 3], ORTA: [0, 0, 1, 1, 2, 2, 3], DUSUK: [0, 0, 0, 1, 1, 2, 2], MINIMUM: [0, 0, 0, 1, 1, 2] },
    "FC PORTO": { MAX: [0, 1, 1, 2, 2, 3, 4], YUKSEK: [0, 0, 1, 1, 2, 2, 3], ORTA: [0, 0, 1, 1, 2, 2, 3], DUSUK: [0, 0, 0, 1, 1, 2, 2], MINIMUM: [0, 0, 0, 1, 1, 2] },
    "SL BENFICA": { MAX: [0, 1, 1, 2, 2, 3, 4], YUKSEK: [0, 0, 1, 1, 2, 2, 3], ORTA: [0, 0, 1, 1, 2, 2, 3], DUSUK: [0, 0, 0, 1, 1, 2, 2], MINIMUM: [0, 0, 0, 1, 1, 2] },

    // --- TIER 4: ORTA-ALT GÜÇ (Ajax, GS, BJK vb.) ---
    // Mucize (3-4 gol) ihtimali eklendi.
    "AJAX AMSTERDAM": { MAX: [0, 0, 1, 1, 2, 3, 4], YUKSEK: [0, 0, 1, 1, 2, 3], ORTA: [0, 0, 0, 1, 1, 2, 2], DUSUK: [0, 0, 0, 1, 1, 2], MINIMUM: [0, 0, 0, 0, 1, 1, 2, 3] },
    "BAYER 04 LEVERKUSEN": { MAX: [0, 0, 1, 1, 2, 3, 4], YUKSEK: [0, 0, 1, 1, 2, 3], ORTA: [0, 0, 0, 1, 1, 2, 2], DUSUK: [0, 0, 0, 1, 1, 2], MINIMUM: [0, 0, 0, 0, 1, 1, 2, 3] },
    "PSV EINDHOVEN": { MAX: [0, 0, 1, 1, 2, 3, 4], YUKSEK: [0, 0, 1, 1, 2, 3], ORTA: [0, 0, 0, 1, 1, 2, 2], DUSUK: [0, 0, 0, 1, 1, 2], MINIMUM: [0, 0, 0, 0, 1, 1, 2, 3] },
    "OLYMPIQUE LYON": { MAX: [0, 0, 1, 1, 2, 3, 4], YUKSEK: [0, 0, 1, 1, 2, 3], ORTA: [0, 0, 0, 1, 1, 2, 2], DUSUK: [0, 0, 0, 1, 1, 2], MINIMUM: [0, 0, 0, 0, 1, 1, 2, 3] },
    "OLYMPIQUE MARSILYA": { MAX: [0, 0, 1, 1, 2, 3, 4], YUKSEK: [0, 0, 1, 1, 2, 3], ORTA: [0, 0, 0, 1, 1, 2, 2], DUSUK: [0, 0, 0, 1, 1, 2], MINIMUM: [0, 0, 0, 0, 1, 1, 2, 3] },
    "FEYENOORD": { MAX: [0, 0, 1, 1, 2, 3, 4], YUKSEK: [0, 0, 1, 1, 2, 3], ORTA: [0, 0, 0, 1, 1, 2, 2], DUSUK: [0, 0, 0, 1, 1, 2], MINIMUM: [0, 0, 0, 0, 1, 1, 2, 3] },
    "GALATASARAY": { MAX: [0, 0, 1, 1, 2, 3, 4], YUKSEK: [0, 0, 1, 1, 2, 3], ORTA: [0, 0, 0, 1, 1, 2, 2], DUSUK: [0, 0, 0, 1, 1, 2], MINIMUM: [0, 0, 0, 0, 1, 1, 2, 3] },
    "BESIKTAS": { MAX: [0, 0, 1, 1, 2, 3, 4], YUKSEK: [0, 0, 1, 1, 2, 3], ORTA: [0, 0, 0, 1, 1, 2, 2], DUSUK: [0, 0, 0, 1, 1, 2], MINIMUM: [0, 0, 0, 0, 1, 1, 2, 3] },

    // --- TIER 5: ALT GÜÇ (Fener, CSKA...) ---
    // Güçlülere karşı nadir de olsa 3-4 gollü sürpriz yapma şansı.
    "SEVILLA FC": { MAX: [0, 0, 1, 1, 2, 3, 4], YUKSEK: [0, 0, 1, 1, 2, 3], ORTA: [0, 0, 0, 1, 1, 2], DUSUK: [0, 0, 0, 0, 1, 1, 2], MINIMUM: [0, 0, 0, 0, 1, 1, 2, 3] },
    "SSC NAPOLI": { MAX: [0, 0, 1, 1, 2, 3, 4], YUKSEK: [0, 0, 1, 1, 2, 3], ORTA: [0, 0, 0, 1, 1, 2], DUSUK: [0, 0, 0, 0, 1, 1, 2], MINIMUM: [0, 0, 0, 0, 1, 1, 2, 3] },
    "VILLARREAL CF": { MAX: [0, 0, 1, 1, 2, 3, 4], YUKSEK: [0, 0, 1, 1, 2, 3], ORTA: [0, 0, 0, 1, 1, 2], DUSUK: [0, 0, 0, 0, 1, 1, 2], MINIMUM: [0, 0, 0, 0, 1, 1, 2, 3] },
    "ATHLETIC BILBAO": { MAX: [0, 0, 1, 1, 2, 3, 4], YUKSEK: [0, 0, 1, 1, 2, 3], ORTA: [0, 0, 0, 1, 1, 2], DUSUK: [0, 0, 0, 0, 1, 1, 2], MINIMUM: [0, 0, 0, 0, 1, 1, 2, 3] },
    "FK KIZILYILDIZ": { MAX: [0, 0, 1, 1, 2, 3, 4], YUKSEK: [0, 0, 1, 1, 2, 3], ORTA: [0, 0, 0, 1, 1, 2], DUSUK: [0, 0, 0, 0, 1, 1, 2], MINIMUM: [0, 0, 0, 0, 1, 1, 2, 3] },
    "FENERBAHCE": { MAX: [0, 0, 1, 1, 2, 3, 4], YUKSEK: [0, 0, 1, 1, 2, 3], ORTA: [0, 0, 0, 1, 1, 2], DUSUK: [0, 0, 0, 0, 1, 1, 2], MINIMUM: [0, 0, 0, 0, 1, 1, 2, 3] },
    "CSKA MOSKOVA": { MAX: [0, 0, 1, 1, 2, 3, 4], YUKSEK: [0, 0, 1, 1, 2, 3], ORTA: [0, 0, 0, 1, 1, 2], DUSUK: [0, 0, 0, 0, 1, 1, 2], MINIMUM: [0, 0, 0, 0, 1, 1, 2, 3] }
};
...
// Takım Güç Oranları (V3 - DENGELENMİŞ)
// Not: Real Madrid gibi takımlar "nerf" yediği için 99'dan aşağı çekildi.
// Alt takımlar sürpriz yapabildiği için puanları yükseltildi.
const teamPowerRatings = {
    // --- TIER 1: MAXIMUM GÜÇ (91-94) ---
    "REAL MADRID": 94,
    "MANCHESTER CITY": 94,
    "BAYERN MUNICH": 93,
    "LIVERPOOL": 93,
    ...
    // --- TIER 2: YÜKSEK GÜÇ (87-90) ---
    "PARIS SAINT GERMAIN": 90,
    "CHELSEA": 89,
    "JUVENTUS": 89,
    "ARSENAL": 88,
    "AC MILAN": 88,
    "TOTTENHAM HOTSPUR FC": 87,

    // --- TIER 3: ORTA GÜÇ (83-86) ---
    "ATLETICO MADRID": 86,
    ...
    // --- TIER 4: DÜŞÜK GÜÇ (79-82) ---
    // Bu grup simülasyonlarda sürpriz şampiyonluklar çıkardığı için puanları artırıldı.
    "AJAX AMSTERDAM": 82,
    "BAYER 04 LEVERKUSEN": 82,
    "PSV EINDHOVEN": 81,
    "OLYMPIQUE LYON": 80,
    "OLYMPIQUE MARSILYA": 80,
    "FEYENOORD": 79,
    "GALATASARAY": 79,
    "BESIKTAS": 79,

    // --- TIER 5: MİNİMUM GÜÇ (75-78) ---
    // Artık "çantada keklik" değiller, mucizevi galibiyetler alabiliyorlar.
    "SEVILLA FC": 78,
    "SSC NAPOLI": 78,
    "VILLARREAL CF": 77,
    "ATHLETIC BILBAO": 77,
...
function oynaMac(t1, t2) {
    ...
    // Normal gol potansiyellerini al
    let golListesiT1 = takimGolVerisi[t1]?.[stratejiT1] || [0];
    let golListesiT2 = takimGolVerisi[t2]?.[stratejiT2] || [0];

    // --- YENİ KAOS FAKTÖRÜ (%15) ---
    // Bu kod, güçlü takımların bazen "kilitlenmesini" ve sürpriz sonuçların çıkmasını sağlar.
    const surprizSans = Math.random();

    if (surprizSans < 0.15) {
        // SENARYO 1: Favori takımın şanssız günü (Kırmızı kart, direkler vb.)
        if (klasmanT1 === 'MAXIMUM_GUC' || klasmanT1 === 'YUKSEK_GUC') {
            golListesiT1 = [0, 0, 1]; // Güçlü takım en fazla 1 atabilir hale gelir
        }
        // Aynı anda zayıf takımın "hayatının maçı"
        if (klasmanT2 === 'DUSUK_GUC' || klasmanT2 === 'MINIMUM_GUC') {
            golListesiT2 = [2, 3, 4]; // Zayıf takım 4 gol atabilecek güce ulaşır
        }
    } else if (surprizSans > 0.85) {
        // SENARYO 2: Tam tersi (Deplasman/İkinci takım favoriyse onun çöküşü)
        if (klasmanT2 === 'MAXIMUM_GUC' || klasmanT2 === 'YUKSEK_GUC') {
            golListesiT2 = [0, 0, 1];
        }
        if (klasmanT1 === 'DUSUK_GUC' || klasmanT1 === 'MINIMUM_GUC') {
            golListesiT1 = [2, 3, 4];
        }
    }

    // Listeden rastgele gol seç
...
function updateUserInfo() {
    // Kullanıcı adını inputtan almıyoruz, zaten user.name içinde kayıtlı
    const betInput = parseInt(document.getElementById("bet-amount").value, 10);
    const selectedTeam = $('#takimSecimi').val();

    // İsim kontrolünü mevcut user objesi üzerinden yapıyoruz
    if (!user.name || user.name === "") {
        user.name = "Misafir"; // Eğer isim yoksa varsayılan ata
    }
    ...
    // user.name = nameInput; satırını kaldırdık. İsim değişmeyecek.

    user.betAmount = betInput;
    user.selectedTeam = selectedTeam;

    // Sadece ekranı güncelle (gerekirse)
