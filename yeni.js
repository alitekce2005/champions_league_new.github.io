...
function updateLeaderboard() {
    // Tablo elementi sayfada var mı kontrol et
    const tbody = document.getElementById('leaderboardBody');

    // EĞER TABLO YOKSA (Klasik Modda sildik) HİÇBİR ŞEY YAPMA VE ÇIK
    if (!tbody) return;

    // --- Buradan sonrası eski kodun aynısı (Diğer modlar için çalışır) ---
